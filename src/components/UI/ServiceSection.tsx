...
export default function ServiceSection() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Safe and painless tooth removal procedures with advanced techniques.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 01-.586 1.414L12 14l-2.414-2.414A2 2 0 019 10.172V5l-1-1z" />
        </svg>
      ),
    },
    {
      title: 'Oral Surgery',
      description: 'Dental and minor oral surgeries performed by experienced specialists.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Professional teeth cleaning and polishing to maintain optimal oral hygiene.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Dentures',
      description: 'Custom-fitted partial and complete dentures to restore your smile.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Permanent tooth replacement solution with titanium implants for natural look and feel.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Durable dental crowns and bridges to restore strength and appearance of damaged teeth.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Orthodontics',
      description: 'Correction of malocclusion with braces, aligners, and other orthodontic treatments.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Smile Design',
      description: 'Comprehensive smile makeovers combining multiple treatments for your perfect smile.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Specialized dental care for children with gentle techniques and child-friendly approach.',
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
        </svg>
  ...
  const prevSlide = () => {
    setCurrentIndex((prevIndex) => 
      prevIndex === 0 ? Math.max(0, services.length - itemsPerPage) : prevIndex - itemsPerPage
    );
  };
    ...
    <div className="bg-gray-50 py-16 px-8">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 min-h-[350px] ">
            {getCurrentServices().map((service, index) => (
              <div 
                ...
                className="bg-white rounded-4xl p-8 w-90  text-center hover:shadow-2xl transition-all duration-300 "
              >
        ...
        <div className="flex justify-center mt-12">
          <button className="bg-primary text-white px-8 py-3 rounded-full font-medium hover:bg-primary transition-colors duration-200 flex items-center gap-2">
            View Services
