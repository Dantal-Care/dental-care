      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="text-white order-3 lg:order-2">
            <h2 className="text-xl lg:text-2xl font-bold mb-4 lg:mb-6 text-center md:text-left">
              Quick Links
            </h2>
            <nav
                ...
                {nav.map((item, index) => (
                  ...
                  >
                    <ArrowRight
                      ...
                      aria-hidden="true"
                    />
                    <p className="text-white/90 group-hover:text-white transition-colors duration-300 text-base text-md lg:text-md font-medium whitespace-nowrap">
                      {item.name}
                    </p>
                  </Link>
                ))}
            ...
            <div className="space-y-4 md:space-y-6 lg:space-y-8 mb-6 md:mb-8 lg:mb-10">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-3 md:gap-4 group">
                ...
                <div className="min-w-0 text-center md:text-left flex-1">
                  <p className="text-xs md:text-sm lg:text-md text-white/80 mb-1 md:mb-2 font-semibold uppercase tracking-wide">
                    Address
                  </p>
                  <address className="text-white text-sm md:text-base lg:text-md leading-relaxed not-italic font-medium">
                    {data.address}
                  </address>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-3 md:gap-4 group">
                ...
                <div className="text-center md:text-left flex-1">
                  ...
                  <a
                    ...
                    className="text-white hover:text-white/90 text-sm md:text-base lg:text-md transition-colors duration-200 font-medium block"
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-3 md:gap-4 group">
                ...
                <div className="text-center md:text-left flex-1 min-w-0">
                  ...
                  <a
                    ...
                    className="text-white hover:text-white/90 text-sm md:text-base lg:text-md transition-colors duration-200 font-medium block break-all"
