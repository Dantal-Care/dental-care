...
const AppointmentModal: React.FC<AppointmentModalProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 bg-transparent bg-opacity-100 backdrop-blur-sm z-[999] flex items-center justify-center p-2 sm:p-4"
      onClick={handleBackdropClick}
    >
      <div className="bg-white rounded-2xl shadow-4xl max-w-2xl w-full max-h-[95vh] sm:max-h-[90vh] md:max-h-[95vh] xl:max-h-[95vh] overflow-y-auto transform transition-all duration-300 scale-100 animate-in mx-2 sm:mx-0 z-[999]">
        {/* Header */}
